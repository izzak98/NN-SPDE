...
# from kpz_train import train_kpz, TrainDGM, TrainMIM, adjusted_initial_condition
...
if __name__ == "__main__":
    ...
    for use_stochastic in [False, True]:
        ...
        dgm_trainer = TrainDGM(lambda1=1, lambda2=1, use_stochastic=use_stochastic)
        ...
        # gen_heat_snapshots(mim_model,
        #                    grid_size=100,
        #                    time_steps=[0.1, 0.25, 0.5, 0.9],
        #                    name=f"DGM_{post_fix}",
        #                    add_values=[0.1, 0.5, 1],
        #                    color_map="viridis",
        #                    min_max=(-2.3, 2.3))
